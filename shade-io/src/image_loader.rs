...
pub async fn load_picture_bytes<CameraImage, CameraFuture, PhotoImage, PhotoFuture>(
    picture_id: &str,
...
pub async fn open_image<CameraImage, CameraFuture, PhotoImage, PhotoFuture>(
    path: &str,
    load_camera_image: CameraImage,
    load_photo_image: PhotoImage,
