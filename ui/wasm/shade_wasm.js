...
export class LayerInfo {
	...
	__destroy_into_raw() {
		...
		this.__wbg_ptr = 0;
		LayerInfoFinalization.unregister(this);
		return ptr;
	}
	free() {
		const ptr = this.__destroy_into_raw();
		wasm.__wbg_layerinfo_free(ptr, 0);
	}
	/**
	 * @returns {number}
	 */
	get canvas_height() {
		...
		const ret = wasm.__wbg_get_layerinfo_canvas_height(this.__wbg_ptr);
		return ret >>> 0;
	}
	/**
	 * @returns {number}
	...
	get canvas_width() {
		if (this.__wbg_ptr == 0) throw new Error("Attempt to use a moved value");
		_assertNum(this.__wbg_ptr);
		const ret = wasm.__wbg_get_layerinfo_canvas_width(this.__wbg_ptr);
		return ret >>> 0;
	}
	/**
	 * @returns {number}
	...
	get layer_count() {
		if (this.__wbg_ptr == 0) throw new Error("Attempt to use a moved value");
		_assertNum(this.__wbg_ptr);
		const ret = wasm.__wbg_get_layerinfo_layer_count(this.__wbg_ptr);
		return ret >>> 0;
	}
	/**
	 * @param {number} arg0
	...
	set canvas_height(arg0) {
		...
		_assertNum(this.__wbg_ptr);
		_assertNum(arg0);
		wasm.__wbg_set_layerinfo_canvas_height(this.__wbg_ptr, arg0);
	}
	/**
	 * @param {number} arg0
	 */
	set canvas_width(arg0) {
		...
		_assertNum(this.__wbg_ptr);
		_assertNum(arg0);
		wasm.__wbg_set_layerinfo_canvas_width(this.__wbg_ptr, arg0);
	}
	/**
	 * @param {number} arg0
	 */
	set layer_count(arg0) {
		...
		_assertNum(this.__wbg_ptr);
		_assertNum(arg0);
		wasm.__wbg_set_layerinfo_layer_count(this.__wbg_ptr, arg0);
	}
}
if (Symbol.dispose)
	LayerInfo.prototype[Symbol.dispose] = LayerInfo.prototype.free;
...
export function apply_tone(
	...
	_assertNum(layer_idx);
	wasm.apply_tone(layer_idx, exposure, contrast, blacks, highlights, shadows);
}
...
function __wbg_get_imports() {
	const import0 = {
		...
		__wbg_log_9601ac4c9b187b51: function () {
			return logError(function (arg0, arg1) {
...
//#endregion
const LayerInfoFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_layerinfo_free(ptr >>> 0, 1),
		  );
