...
if (Symbol.dispose) LayerInfo.prototype[Symbol.dispose] = LayerInfo.prototype.free;
 ...
 */
export function apply_tone(layer_idx, exposure, contrast, blacks, highlights, shadows) {
    _assertNum(layer_idx);
...
//#endregion
const LayerInfoFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_layerinfo_free(ptr >>> 0, 1));
